...
class RefLocalTrackingModel041ArgumentsDict(TypedDict):
...
class RefLocalTrackingModel041Arguments(ModelArguments[RefLocalTrackingModel041ArgumentsDict]):
    def __init__(self, dic: RefLocalTrackingModel041ArgumentsDict):
        self.dic = dic
    ...
    @classmethod
    def convert_str_dict(cls, string_dict: Dict[str, str]) -> RefLocalTrackingModel041ArgumentsDict:
...
class RefLocalTrackingModel041Manager(
        CommonModelManager,
        CommonModelManagerDictGeneratable[RefLocalTrackingModel041ArgumentsDict]):
    def __init__(
            self,
        ...
        __model_default_args = get_default_args(self.ref_local_tracking_model_041)
        __model_default_values = RefLocalTrackingModel041Arguments(__model_default_args)
    ...
    @classmethod
    def init_with_dict(cls, option_dict: Optional[RefLocalTrackingModel041ArgumentsDict] = None):
        if option_dict is not None:
            ref_local_tracking_model_041_arguments = RefLocalTrackingModel041Arguments(option_dict)
            return cls(
                    unet_l4_model_main=ref_local_tracking_model_041_arguments.unet_l4_model_main,
                    unet_l4_model_ref=ref_local_tracking_model_041_arguments.unet_l4_model_ref,
                    input_main_image_shape=ref_local_tracking_model_041_arguments.input_main_image_shape,
                    input_ref_image_shape=ref_local_tracking_model_041_arguments.input_ref_image_shape,
                    input_ref_bin_label_shape=ref_local_tracking_model_041_arguments.input_ref_bin_label_shape)
        else:
            return cls()
    ...
    def init_with_str_dict(cls, option_str_dict: Optional[Dict[str, str]] = None):
        if option_str_dict is not None:
            unet_level_arguments_dict = RefLocalTrackingModel041Arguments.convert_str_dict(option_str_dict)
            return cls.init_with_dict(unet_level_arguments_dict)
        else:
            return cls()
    
    def setup_model(self) -> Model:
        return self.ref_local_tracking_model_041(
    ...
    # noinspection DuplicatedCode
    @staticmethod
    def ref_local_tracking_model_041(
