...
from imagemodel.experimental.reference_tracking.models.ref_local_tracking_model_041 import \
    RefLocalTrackingModel041Manager
...
if __name__ == "__main__":
    ...
    ...     --workdir="/imagemodel" \
    ...     imagemodel/tkl:1.2
    >>> python imagemodel/experimental/reference_tracking/models/trainers/ref_local_tracking_model_041_trainer.py \
    ...     --model_name ref_local_tracking_model_041 \
    ...
    ...     --training_pipeline rt_cell_tracking_training_1 \
    ...     --validation_pipeline rt_cell_tracking_validation_1 \
    ...     --run_id reference_tracking__20210525_210517 \
    ...     --without_early_stopping \
    ...     --batch_size 2
    ...
    parser: ArgumentParser = ArgumentParser(
            description="Arguments for Ref Local Tracking model 041 in Reference Tracking",
    ...
    if tpu_name_optional:
        ...
        # u_net_model2 = tf.keras.models.clone_model(u_net_model)
        # u_net_model2.set_weights(u_net_model.get_weights())
    manager = RefLocalTrackingModel041Manager(
