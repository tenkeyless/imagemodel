...
def get_file_from_google_bucket(file_path: str, save_to_file_path: str, skip_if_exist: bool = True):
    if (not skip_if_exist) or (skip_if_exist and (not os.path.isfile(save_to_file_path))):
