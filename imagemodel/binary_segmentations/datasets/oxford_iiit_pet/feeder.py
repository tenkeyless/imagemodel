...
class BSOxfordIIITPetFeeder(BSFeeder):
    ...
    def input_helper(self) -> BSFeederInputHelper:
        return BSOxfordIIITPetFeederInputHelper(data_descriptor=self._oxford_iiit_pet_3_data_descriptor)

    @property
    def output_helper(self) -> BSFeederOutputHelper:
        return BSOxfordIIITPetFeederOutputHelper(data_descriptor=self._oxford_iiit_pet_3_data_descriptor)
