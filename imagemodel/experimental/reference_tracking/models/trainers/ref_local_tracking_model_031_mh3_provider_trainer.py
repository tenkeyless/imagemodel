...
from imagemodel.experimental.reference_tracking.models.ref_local_tracking_model_031_mh3 import \
    RefLocalTrackingModel031MH3Manager
...
if __name__ == "__main__":
    ...
    ... ref_local_tracking_model_031_mh3_provider_trainer.py \
    ...     --model_name ref_local_tracking_model_031_mh3 \
    ...     --head_num 4 \
    ...
    if tpu_name_optional:
        ...
        # u_net_model2 = tf.keras.models.clone_model(u_net_model)
        # u_net_model2.set_weights(u_net_model.get_weights())
    manager = RefLocalTrackingModel031MH3Manager(
