...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        type=str,
        help="Should be one of models in `Datasets` of `imagemodel/binary_segmentations/configs/datasets.py`. \n"
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Should be one of models in `Models` of `imagemodel/binary_segmentations/configs/models.py`. \n"
        "ex) 'unet'",
    )
    parser.add_argument(
        "--model_option",
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Name of base folder. 'binary_segmentations/training', '/user/name/path/folder'.",
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        "--optimizer",
        type=str,
        help="Loss should be exist in `imagemodel.binary_segmentations.configs.optimizers`. \n"
        "ex) 'adam1'",
    )
    parser.add_argument(
        "--losses",
        ...
        "Loss should be exist in `imagemodel.binary_segmentations.configs.losses`. \n"
