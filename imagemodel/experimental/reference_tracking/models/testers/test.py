...
from imagemodel.experimental.reference_tracking.datasets.cell_tracking.preprocessor import RTCellTrackingPreprocessor
from imagemodel.experimental.reference_tracking.datasets.pipeline import RTPipeline
from imagemodel.experimental.reference_tracking.datasets.rt_augmenter import RTAugmenter
from imagemodel.experimental.reference_tracking.datasets.rt_preprocessor import RTPreprocessor
from imagemodel.experimental.reference_tracking.datasets.rt_regularizer import BaseRTRegularizer, RTRegularizer
from imagemodel.experimental.reference_tracking.models.testers.rt_test_reporter import RTTestReporter
...
if __name__ == "__main__":
    ...
    ...     --workdir="/imagemodel" \
    ...     imagemodel/tkl:1.2
    >>> python imagemodel/experimental/reference_tracking/models/testers/test.py \
...
# training__model_ref_local_tracking_model_031_mh__run_reference_tracking__20210514_025537.epoch_14
    ...
    >>> python imagemodel/experimental/reference_tracking/models/tester/test.py \
    ...     --model_name ref_local_tracking_model_031_mh \
