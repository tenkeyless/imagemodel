...
from imagemodel.experimental.reference_tracking.models. \
    ref_local_tracking_model_042 import RefLocalTrackingModel042Manager
...
if __name__ == "__main__":
    ...
    ... ref_local_tracking_model_042_provider_trainer.py \
    ...     --model_name ref_local_tracking_model_042 \
    ...
    ...     --training_base_folder /data/tracking_training \
    ...     --validation_base_folder /data/tracking_validation \
    ...     --run_id reference_tracking__20210525_215454 \
    ...     --without_early_stopping \
    ...     --batch_size 2
    ...
    parser: ArgumentParser = ArgumentParser(
            description="Arguments for Ref Local Tracking model 042 in Reference Tracking",
    ...
    if tpu_name_optional:
        ...
        # u_net_model2 = tf.keras.models.clone_model(u_net_model)
        # u_net_model2.set_weights(u_net_model.get_weights())
    manager = RefLocalTrackingModel042Manager(
