...
from tensorflow.keras.layers import Add, Conv2D, Dropout, Input, Layer, MaxPooling2D, Softmax, UpSampling2D, concatenate
...
class RefLocalTrackingModel043ArgumentsDict(TypedDict):
...
class RefLocalTrackingModel043Arguments(ModelArguments[RefLocalTrackingModel043ArgumentsDict]):
    def __init__(self, dic: RefLocalTrackingModel043ArgumentsDict):
        self.dic = dic
    ...
    @classmethod
    def convert_str_dict(cls, string_dict: Dict[str, str]) -> RefLocalTrackingModel043ArgumentsDict:
...
class RefLocalTrackingModel043Manager(
        CommonModelManager,
        CommonModelManagerDictGeneratable[RefLocalTrackingModel043ArgumentsDict]):
    def __init__(
            self,
        ...
        __model_default_args = get_default_args(self.ref_local_tracking_model_043)
        __model_default_values = RefLocalTrackingModel043Arguments(__model_default_args)
    ...
    @classmethod
    def init_with_dict(cls, option_dict: Optional[RefLocalTrackingModel043ArgumentsDict] = None):
        if option_dict is not None:
            ref_local_tracking_model_043_arguments = RefLocalTrackingModel043Arguments(option_dict)
            return cls(
                    unet_l4_model_main=ref_local_tracking_model_043_arguments.unet_l4_model_main,
                    unet_l4_model_ref=ref_local_tracking_model_043_arguments.unet_l4_model_ref,
                    input_main_image_shape=ref_local_tracking_model_043_arguments.input_main_image_shape,
                    input_ref_image_shape=ref_local_tracking_model_043_arguments.input_ref_image_shape,
                    input_ref_bin_label_shape=ref_local_tracking_model_043_arguments.input_ref_bin_label_shape)
        else:
            return cls()
    ...
    def init_with_str_dict(cls, option_str_dict: Optional[Dict[str, str]] = None):
        if option_str_dict is not None:
            unet_level_arguments_dict = RefLocalTrackingModel043Arguments.convert_str_dict(option_str_dict)
            return cls.init_with_dict(unet_level_arguments_dict)
        else:
            return cls()
    
    def setup_model(self) -> Model:
        return self.ref_local_tracking_model_043(
    ...
    # noinspection DuplicatedCode
    @staticmethod
    def ref_local_tracking_model_043(
        ...
        add_layer = Add()([output_softmax, main_unet[4]])
        
        output_conv_layer: Layer = DepthwiseConv2D(
                kernel_size=3,
                padding="same",
                depthwise_initializer="he_normal",
                activation="softmax")(add_layer)
        ...
        return Model(
                ...
                outputs=[main_unet[4], ref_unet[4], output_conv_layer])
