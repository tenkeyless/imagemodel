...
from imagemodel.experimental.reference_tracking.models. \
    ref_local_tracking_model_043 import RefLocalTrackingModel043Manager
...
if __name__ == "__main__":
    ...
    ... ref_local_tracking_model_043_provider_trainer.py \
    ...     --model_name ref_local_tracking_model_043 \
    ...
    parser: ArgumentParser = ArgumentParser(
            description="Arguments for Ref Local Tracking model 043 in Reference Tracking",
    ...
    if tpu_name_optional:
        ...
        # u_net_model2 = tf.keras.models.clone_model(u_net_model)
        # u_net_model2.set_weights(u_net_model.get_weights())
    manager = RefLocalTrackingModel043Manager(
