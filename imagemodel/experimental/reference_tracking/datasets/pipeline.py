...
from imagemodel.experimental.reference_tracking.datasets.rt_augmenter import BaseRTAugmenter, RTAugmenter
from imagemodel.experimental.reference_tracking.datasets.rt_feeder import RTFeeder
...
class RTPipeline(Pipeline[RTFeeder, RTAugmenter, RTRegularizer, RTPreprocessor]):
    def __init__(
        ...
        Examples
        --------
        >>> from imagemodel.experimental.reference_tracking.datasets.cell_tracking.\
        ...     feeder import RTGSCellTrackingTrainingFeeder
